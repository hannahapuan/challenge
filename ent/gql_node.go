...
func (ia *IPAddress) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     ia.ID,
		Type:   "IPAddress",
		Fields: make([]*Field, 5),
	...
	var buf []byte
	if buf, err = json.Marshal(ia.UUID); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "uuid.UUID",
	...
	if buf, err = json.Marshal(ia.ResponseCode); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(ia.IPAddress); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case ipaddress.Table:
		n, err := c.IPAddress.Query().
			Where(ipaddress.ID(id)).
			CollectFields(ctx, "IPAddress").
			Only(ctx)
		if err != nil {
			return nil, err
		}
